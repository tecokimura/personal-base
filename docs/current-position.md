...
| 現在の着手単位 | PMO-97〜104 が実装待ち、PMO-105 がレビュー待ち |
| 現在の実装ブランチ | `feat/phase3`（PMO-106・107・108・109 はマージ済み） |
| 次の具体作業 | cron（claude-auto）を再開し、PMO-97 から順次実装する |
...
フェーズ 2.5（完了）
  ...
  2. 完了済み主要課題: PMO-71（組織図改善）、PMO-72〜73（表示名・在籍判定）、
    ...
    ↓
フェーズ 3（進行中）
  完了済み: PMO-84・87・88・89・90・91・92・93・94・95・96・100・106・107・108・109
...
| PMO-104 | Wiki のセットアップ手順を4テナント体制に更新（PMO-103 完了後） | 実装待ち |
| PMO-105 | バックアップコード残枚数に応じた警告バナーの表示 | レビュー待ち |
