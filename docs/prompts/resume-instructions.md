...
現時点の次論点は `退職者 / 休職者 / 論理削除 / ログイン停止` の残り整理と、このテーマを主要論点完了として閉じるかの確認である。
...
- 次は [docs/decision-backlog.md](/home/keith/Documents/projects/personal-base/docs/decision-backlog.md) の先頭課題である `退職者 / 休職者` の論点が主要完了扱いにできるかを確認し、必要なら後続論点へ切り出す
